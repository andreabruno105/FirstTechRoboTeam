...
public class InseguePallinaStatico extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // ===== 1️⃣ CENTRA IL BLOB =====
            if (!isCentral) {
                isCentral = centerBlob(colorLocator, centerx, centerTolerance);
            }
    ...
    private boolean centerBlob(ColorBlobLocatorProcessor colorLocator, int centerx, int centerTolerance) {
